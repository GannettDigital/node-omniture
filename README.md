...
## what is it
omniture is a minimal Node.js module wrapper for [Omniture's REST API](http://developer.omniture.com).
...
Here's an example of initializing with a few configuration options.
      ...
      // generic Client
      var Client = require('omniture').Client;
      var c = new Client(username, sharedSecret, 'sanJose');

      // Report
      var Report = require('omniture').Report;
